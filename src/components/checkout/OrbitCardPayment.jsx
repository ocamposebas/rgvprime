...
const appearance = {
  ...
  variables: {
    ...
    colorText: "#f7f3f4",
    colorDanger: "#f16b76",
    colorTextSecondary: "#aaa1a4",
    colorTextPlaceholder: "#71696c",
    fontFamily: 'Inter, "Helvetica Neue", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif',
    fontSizeBase: "14px",
    borderRadius: "9px",
    spacingUnit: "4px",
    focusBoxShadow: "0 0 0 3px rgba(225, 58, 72, 0.13)",
    focusOutline: "none",
  },
  rules: {
    ".Input": { backgroundColor: "#0e0e11", border: "1px solid #302b2e", boxShadow: "none", padding: "12px" },
    ".Input:hover": { borderColor: "#55474c" },
    ".Input:focus": { borderColor: "#e13a48", boxShadow: "0 0 0 3px rgba(225,58,72,.12)" },
    ".Input--invalid": { borderColor: "#f16b76", boxShadow: "0 0 0 3px rgba(241,107,118,.1)" },
    ".Label": { color: "#d8cfd2", fontSize: "11px", fontWeight: "600" },
    ".Label--invalid, .Error": { color: "#f48a93" },
    ".Tab, .AccordionItem": { backgroundColor: "#0e0e11", border: "1px solid #302b2e", boxShadow: "none" },
    ".Tab:hover": { color: "#fff", borderColor: "#55474c" },
    ".Tab:focus": { boxShadow: "0 0 0 3px rgba(225,58,72,.12)" },
    ".Tab--selected": { backgroundColor: "#1b1013", borderColor: "#c72b39", boxShadow: "none" },
    ".TabLabel": { fontWeight: "600" },
    ".TermsText": { color: "#888084", fontSize: "11px" },
