...
define( 'ORBIT_RELAY_VERSION', '1.5.0' );
...
require_once ORBIT_RELAY_DIR . 'includes/class-orbit-relay-hosted-secret-store.php';
...
require_once ORBIT_RELAY_DIR . 'includes/class-orbit-relay-hosted-checkout.php';
