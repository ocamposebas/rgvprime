...
require_once RGV_COA_DIR . 'includes/class-rgv-coa-integrity.php';
require_once RGV_COA_DIR . 'includes/class-rgv-coa-rest-api.php';
require_once RGV_COA_DIR . 'includes/class-rgv-coa-admin.php';
require_once RGV_COA_DIR . 'includes/class-rgv-coa-migration.php';
