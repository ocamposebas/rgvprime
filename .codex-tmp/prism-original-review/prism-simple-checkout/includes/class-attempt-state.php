...
final class Attempt_State {
	...
	public function store_attempt( array $attempt ): void {
		...
		$keys = array( 'attempt_id', 'fence', 'cart_fingerprint', 'identity_digest', 'amount_minor', 'currency', 'email', 'publishable_key', 'connected_account', 'expires_at', 'operation_id', 'claim_key', 'claim_owner', 'claim_fence', 'research_record_id', 'research_record_digest', 'service_mode', 'woo_order_id' );
		$clean = array();
		foreach ( $keys as $key ) {
