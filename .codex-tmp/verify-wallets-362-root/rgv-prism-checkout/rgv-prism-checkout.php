...
final class RGV_Storefront_Card_Wallet_Return {
  ...
  public function enqueue_storefront_checkout() {
    ...
    // preserving the stable card-only Payment Element. Run before the provider
    // initializes Elements so there is no method reflow.
    $card_only_script = <<<'JS'
(function () {
...
JS;
  ...
  public function neutralize_frontend_branding() {
    ...
    // Stripe account. Keep native Express wallets while preserving the stable
    // card-only Payment Element. The server-side confirmation flow remains
    // unchanged.
    $card_only_script = <<<'JS'
(function () {
