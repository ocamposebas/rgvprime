...
JS;
  ...
  public function render_payment_header() {
    ...
    echo '<p class="rgv-payment-intro__copy">Review your order, then complete your payment securely.</p>';
    echo '<div class="rgv-payment-intro__trust" aria-label="Checkout protections">';
    echo '<span><b aria-hidden="true">&#10003;</b> Encrypted payment</span><span><b aria-hidden="true">&#10003;</b> Card details stay private</span>';
    echo '</div></section>';
  }
